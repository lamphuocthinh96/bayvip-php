...
(function() {
    ...
    function ea(a, b, c) {
        if (t && wa) {
            ...
            a.width = b * J;
            a.height = c * J;
            na !== fa && (a.style.width = b + "px", a.style.height = c + "px", d.scale(J, J))
    ...
    function u(a, b, c) {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this._container.innerHTML = "", b = a = 0, a = this._options.width ? this.width : 0 < this._container.clientWidth ? this._container.clientWidth : this.width, b = this._options.height ? this.height : 0 < this._container.clientHeight ? this._container.clientHeight : this.height, this.width = a, this.height = b, this.x1 =
            ...
            this.canvas = U(a, b), this.canvas.style.position = "absolute", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = U(a, b), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")), this.overlaidCanvas =
                U(a, b), this.overlaidCanvas.style.position = "absolute", this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", this._eventManager = new $(this), F(window, "resize", function() {
                ...
                this.bounds = {
                    ...
                    d._mouseEventHandler(a)
                }), F(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart",
                    function(a) {
    ...
    function ja(a, b, c) {
        ...
        "undefined" === typeof this._options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
        this.lineHeight = da(this.fontFamily,
    ...
    function C(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++) this.stripLines.push(new ka(this.chart, this._options.stripLines[b], a.theme, ++this.chart._eventManager.lastObjectId, this));
            ...
            return function(k, p, h) {
                ...
                return h = p.replace(a, function(a) {
                    switch (a) {
                        ...
                        case "zzz":
                            return (0 < A ? "-" : "+") + L(Math.floor(Math.abs(A) / 60), 2) + L(Math.abs(A) %
                                60, 2);
                        default:
        ...
        W = function(a, b, c) {
            ...
            for (var w = 0; k && w < k.length; w++)
                if (b = k[w], "." === b && 0 > p) p = w;
                    ...
                    0 > p ? (h.push(b), "#" === b || "0" === b ? n++ : "," === b && q++) : (m.push(b), "#" !== b && "0" !== b || l++)
                }
            ...
            a = (b[1] + "").split("");
            g && "0" === g[0] && g.shift();
            for (w = r = k = l = p = 0; 0 < h.length;)
                if (b = h.pop(), "#" === b || "0" === b)
                    if (p++, p === n) {
                        var v = g,
                            g = [];
                        if ("0" === b)
                            for (b = n - l - (v ? v.length : 0); 0 < b;) v.unshift("0"), b--;
                        for (; 0 <
                            v.length;) c = v.pop() + c, w++, 0 === w % r && (k === q && 0 < v.length) && (c = f + c);
                        d && (c = "-" + c)
                    } else 0 < g.length ? (c = g.pop() + c, l++, w++) : "0" === b && (c = "0" + c, l++, w++), 0 === w % r && (k === q && 0 < g.length) && (c = f + c);
            ...
            d = "";
            for (f = !1; 0 < m.length;) b = m.shift(), "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === b && (d += "0", f = !0) : 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? d += b.slice(1, b.length - 1) : "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? d += b : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), d += b.replace(/[0]+/, function(a) {
                return L(s, a.length)
            }));
            return c + ((f ? e : "") + d)
        },
    ...
    u.prototype._updateOptions =
        function() {
            ...
            this._options.zoomEnabled ? (this._zoomButton || (R(this._zoomButton = document.createElement("button")), P(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), F(this._zoomButton, "click", function() {
                a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, P(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, P(a, a._zoomButton, "pan"));
                a.render()
            })), this._resetButton || (R(this._resetButton = document.createElement("button")), P(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), F(this._resetButton, "click", function() {
                a._toolTip.hide();
                a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, P(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
                ...
                a._dispatchRangeEvent("rangeChanged",
                    "reset")
            }), this.overlaidCanvas.style.cursor = a._defaultCursor), this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), ga(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))) : this.panEnabled = this.zoomEnabled = !1;
            this._menuButton ? this.exportEnabled ? ga(this._menuButton) : R(this._menuButton) : this.exportEnabled && t && (this._menuButton = document.createElement("button"),
                P(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), F(this._menuButton, "click", function() {
            ...
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? P(a, a._zoomButton, "zoom") : P(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && P(a, a._resetButton, "reset"));
            if ("undefined" === typeof la.Chart.creditHref) this.creditHref = "http://canvasjs.com/", this.creditText = "";
    ...
    u.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * J || this.canvas.height !== b * J ? (ea(this.canvas, a, b), ea(this.overlaidCanvas, a, b), ea(this._eventManager.ghostCanvas, a, b), !0) : !1
    };
    u.prototype._initialize = function() {
        ...
        for (var a = 0, b = 0; b < this._options.data.length; b++)
            if (a++, !this._options.data[b].type || 0 <= u._supportedChartTypes.indexOf(this._options.data[b].type)) {
                ...
                null === c.color ? 1 < this._options.data.length ? (c._colorSet = [this._selectedColorSet[c.index % this._selectedColorSet.length]], c.color = this._selectedColorSet[c.index % this._selectedColorSet.length]) : c._colorSet = "line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" ===
                    c.type || "splineArea" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "candlestick" === c.type || "ohlc" === c.type ? [this._selectedColorSet[0]] : this._selectedColorSet : c._colorSet = [c.color];
    ...
    u.prototype.render = function(a) {
        ...
        for (a = 0; a < this.data.length; a++)
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) this.data[a].axisYType && "primary" !== this.data[a].axisYType ?
        ...
        this.axisY && this.axisY2 && (0 < this.axisY.gridThickness && "undefined" === typeof this.axisY2._options.gridThickness ? this.axisY2.gridThickness = 0 : 0 < this.axisY2.gridThickness &&
            "undefined" === typeof this.axisY._options.gridThickness && (this.axisY.gridThickness = 0));
        var c = !1;
        ...
        this._processData();
        this._options.title && (this._title = new aa(this, this._options.title), this._title.dockInsidePlotArea ? b.push(this._title) : this._title.render());
        if (this._options.subtitles)
            for (a = 0; a < this._options.subtitles.length; a++) this.subtitles = [], c = new ia(this, this._options.subtitles[a]), this.subtitles.push(c), c.dockInsidePlotArea ? b.push(c) : c.render();
        ...
        if ("normal" ===
            this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) C.setLayoutAndRender(this.axisX, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (b = this.plotInfo.plotTypes[a],
                ...
                "line" === f.type ? g = this.renderLine(f) : "stepLine" === f.type ? g = this.renderStepLine(f) : "spline" === f.type ? g = this.renderSpline(f) : "column" === f.type ? g = this.renderColumn(f) : "bar" === f.type ? g = this.renderBar(f) : "area" === f.type ? g = this.renderArea(f) : "stepArea" === f.type ? g = this.renderStepArea(f) : "splineArea" === f.type ? g = this.renderSplineArea(f) :
                    ...
                    f.type ? g = this.renderCandlestick(f) : "ohlc" === f.type ? g = this.renderCandlestick(f) : "rangeColumn" === f.type ? g = this.renderRangeColumn(f) : "rangeBar" === f.type ? g = this.renderRangeBar(f) : "rangeArea" === f.type ? g = this.renderRangeArea(f) : "rangeSplineArea" === f.type && (g = this.renderRangeSplineArea(f));
    ...
    u.prototype.categoriseDataSeries = function() {
        for (var a = "", b = 0; b < this.data.length; b++)
            if (a = this.data[b], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= u._supportedChartTypes.indexOf(a.type)) {
                for (var c =
                        null, d = !1, e = null, f = !1, g = 0; g < this.plotInfo.plotTypes.length; g++)
    ...
    u.prototype._processData = function() {
        ...
        for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var b = this.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++) {
                var d = b.plotUnits[c];
                "line" === d.type || "stepLine" === d.type || "spline" === d.type || "column" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "bar" === d.type || "bubble" === d.type || "scatter" === d.type ? this._processMultiseriesPlotUnit(d) : "stackedColumn" === d.type || "stackedBar" === d.type ||
                    "stackedArea" === d.type ? this._processStackedPlotUnit(d) : "stackedColumn100" === d.type || "stackedBar100" === d.type || "stackedArea100" === d.type ? this._processStacked100PlotUnit(d) : "candlestick" !== d.type && "ohlc" !== d.type && "rangeColumn" !== d.type && "rangeBar" !== d.type && "rangeArea" !== d.type && "rangeSplineArea" !== d.type || this._processMultiYPlotUnit(d)
            }
    };
    u.prototype._processMultiseriesPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1,
                    g = 0; g < a.dataSeriesIndexes.length; g++) {
                var k = this.data[a.dataSeriesIndexes[g]],
                    p = 0,
                    h = !1,
                    m = !1;
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var n = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                ...
                for (p = 0; p < k.dataPoints.length; p++) {
                    ...
                    if (0 < p) {
                        ...
                        null !== e && null !== k.dataPoints[p - 1].y && (q = e - k.dataPoints[p - 1].y, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q))
                    }
                    if (!(d < n) || h) {
                        if (!h && (h = !0, 0 < p)) {
                            p -= 2;
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], k = [], p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = this.data[a.dataSeriesIndexes[p]],
                    ...
                    n = !1,
                    l = !1;
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var q = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum :
                    this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                ...
                if (h.dataPoints[m].x && h.dataPoints[m].x.getTime ||
                    "dateTime" === h.xValueType) f = !0;
                for (m = 0; m < h.dataPoints.length; m++) {
                    "undefined" === typeof h.dataPoints[m].x && (h.dataPoints[m].x = m);
                    h.dataPoints[m].x.getTime ? (f = !0, d = h.dataPoints[m].x.getTime()) : d = h.dataPoints[m].x;
                    e = h.dataPoints[m].y;
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    if (0 < m) {
                        var s = d - h.dataPoints[m - 1].x;
                        0 > s && (s *= -1);
                        c.minDiff > s && 0 !== s && (c.minDiff = s);
                        null !== e && null !== h.dataPoints[m - 1].y && (s = e - h.dataPoints[m - 1].y, 0 > s && (s *= -1), b.minDiff > s && 0 !== s && (b.minDiff = s))
                    }
                    if (!(d < q) || n) {
                        if (!n && (n = !0, 0 < m)) {
                            m -= 2;
                        ...
                        if (d > r && !l) l = !0;
                        else if (d > r && l) continue;
                        h.dataPoints[m].label && (a.axisX.labels[d] = h.dataPoints[m].label);
                        d < c.viewPortMin && (c.viewPortMin = d);
                        d > c.viewPortMax && (c.viewPortMax = d);
            ...
            for (m in g) g.hasOwnProperty(m) && !isNaN(m) && (a = g[m], a < b.min && (b.min = a), a > b.max && (b.max = a), m < c.viewPortMin || m > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin =
                a), a > b.viewPortMax && (b.viewPortMax = a)));
            for (m in k) k.hasOwnProperty(m) && !isNaN(m) && (a = k[m], a < b.min && (b.min = a), a > b.max && (b.max = a), m < c.viewPortMin || m > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)))
        }
    };
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, k = !1, p = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var m = this.data[a.dataSeriesIndexes[h]],
                    ...
                    l = !1,
                    q = !1;
                if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var r = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                    s = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this._options.axisX && this._options.axisX.viewportMaximum ? this._options.axisX.viewportMaximum :
                ...
                for (n = 0; n < m.dataPoints.length; n++) {
                    "undefined" === typeof m.dataPoints[n].x && (m.dataPoints[n].x = n);
                    m.dataPoints[n].x.getTime ? (f = !0, d = m.dataPoints[n].x.getTime()) : d = m.dataPoints[n].x;
                    e = m.dataPoints[n].y;
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    if (0 < n) {
                        var w = d - m.dataPoints[n - 1].x;
                        0 > w && (w *= -1);
                        c.minDiff > w && 0 !== w && (c.minDiff = w);
                        null !== e && null !==
                            m.dataPoints[n - 1].y && (w = e - m.dataPoints[n - 1].y, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w))
                    }
                    if (!(d < r) || l) {
                        if (!l && (l = !0, 0 < n)) {
                            n -= 2;
            ...
            g &&
                !k ? (b.max = 99, b.min = 1) : g && k ? (b.max = 99, b.min = -99) : !g && k && (b.max = -1, b.min = -99);
            b.viewPortMin = b.min;
            b.viewPortMax = b.max;
            a.dataPointYSums = p
        }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, k = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var q = this.sessionVariables.axisX.newViewportMinimum ?
                    ...
                    r = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this._options.axisX && this._options.axisX.viewportMaximum ? this._options.axisX.viewportMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
                if (h.dataPoints[m].x && h.dataPoints[m].x.getTime || "dateTime" === h.xValueType) k = !0;
                for (m = 0; m < h.dataPoints.length; m++) {
                    "undefined" === typeof h.dataPoints[m].x && (h.dataPoints[m].x = m);
                    h.dataPoints[m].x.getTime ? (k = !0, d = h.dataPoints[m].x.getTime()) : d = h.dataPoints[m].x;
                    (e = h.dataPoints[m].y) && e.length && (f = Math.min.apply(null, e), g = Math.max.apply(null, e));
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    f < b.min && (b.min = f);
                    g > b.max && (b.max = g);
                    if (0 < m) {
                        var s = d - h.dataPoints[m - 1].x;
                        0 > s && (s *= -1);
                        c.minDiff > s && 0 !== s && (c.minDiff =
                            s);
                        null !== e[0] && null !== h.dataPoints[m - 1].y[0] && (s = e[0] - h.dataPoints[m - 1].y[0], 0 > s && (s *= -1), b.minDiff > s && 0 !== s && (b.minDiff = s))
                    }
                    if (!(d < q) || n) {
                        if (!n && (n = !0, 0 < m)) {
                            m -= 2;
    ...
    u.prototype.getDataPointAtXY =
        function(a, b, c) {
            ...
            for (c = 0; c < d.length; c++) b && "line" !== d[c].dataSeries.type && "stepLine" !== d[c].dataSeries.type &&
                "area" !== d[c].dataSeries.type && "stepArea" !== d[c].dataSeries.type || (a ? d[c].distance <= a.distance && (a = d[c]) : a = d[c]);
            return a
        };
    u.prototype.getObjectAtXY = function(a, b, c) {
        var d = null;
        if (c = this.getDataPointAtXY(a, b, c || !1)) d = c.dataSeries.dataPointIds[c.dataPointIndex];
        else if (t) d = va(a, b, this._eventManager.ghostCtx);
        else
    ...
    u.prototype.getAutoFontSize = function(a, b, c) {
        a /= 400;
        return Math.round(Math.min(this.width,
            this.height) * a)
    };
        ...
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(c && 1 < c.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1;
                    ...
                    for (c = 0; c < b.length; c++) e = b[c], f = document.createEvent("MouseEvent"), f.initMouseEvent(e, !0, !0, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1, !1, !1, !1, 0, null), d.target.dispatchEvent(f), a.preventManipulation &&
        ...
        function(a) {
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                    ...
                    if (!e) {
                        if (u.capturedEventParam) d = u.capturedEventParam, "mouseup" === c && (u.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup",
                            d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) && d[c].call(d.context, b.x, b.y);
                            ...
                            for (e = 0; e < this._events.length; e++)
                                if (this._events[e].hasOwnProperty(c)) {
                                    ...
                                    if (b.x >= f.x1 && b.x <= f.x2 && b.y >= f.y1 && b.y <= f.y2) {
                                        ...
                                        "mousedown" === c && !0 === d.capture ? (u.capturedEventParam = d, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.body.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === c && (d.chart.overlaidCanvas.releaseCapture ?
                                            d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", this._mouseEventHandler, !1));
                                        break
                                    } else d = null
                                }
        ...
        function(a, b) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++) c = this._axes[e], c.viewportMinimum < c.minimum ? (f = c.minimum - c.viewportMinimum, c.sessionVariables.newViewportMinimum =
                            c.viewportMinimum + f, c.sessionVariables.newViewportMaximum = c.viewportMaximum + f, g = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum - c.maximum, c.sessionVariables.newViewportMinimum = c.viewportMinimum - f, c.sessionVariables.newViewportMaximum = c.viewportMaximum - f, g = !0);
                        ...
                        2 < Math.abs(c -
                            e) && 2 < Math.abs(d - f) && this._zoomPanToSelectedRegion(c, d, e, f) && (g = !0)
                    }
                    g && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), g && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (ga(this._zoomButton, this._resetButton), P(this, this._zoomButton, "pan"), P(this, this._resetButton, "reset")))
                }
            }
            this.isDrag = !1
        };
    u.prototype._plotAreaMouseMove = function(a, b) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            }, this._zoomPanToSelectedRegion(e.x1, e.y1, e.x2, e.y2, !0) && (this._dispatchRangeEvent("rangeChanging", "pan"), this.render(), this._dispatchRangeEvent("rangeChanged", "pan"), this.dragStartPoint.x = a, this.dragStartPoint.y = b)) : this.zoomEnabled && (this.resetOverlayedCanvas(), c = this.overlaidCanvasCtx.globalAlpha, this.overlaidCanvasCtx.globalAlpha = 0.7, this.overlaidCanvasCtx.fillStyle = "#A0ABB8", this.overlaidCanvasCtx.fillRect(e ?
                this.dragStartPoint.x : this.plotArea.x1, f ? this.dragStartPoint.y : this.plotArea.y1, e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, f ? b - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1), this.overlaidCanvasCtx.globalAlpha = c))
    ...
    u.prototype._zoomPanToSelectedRegion = function(a, b, c, d, e) {
        ...
        this.axisY2 &&
            g && p.push(this.axisY2);
        f = [];
        for (g = 0; g < p.length; g++) {
            var m = p[g],
                n = m.convertPixelToValue({
                    x: a,
                    y: b
                }),
                l = m.convertPixelToValue({
                    x: c,
                    y: d
                });
            if (n > l) var q = l,
            ...
            if (isFinite(m.dataInfo.minDiff))
                if (!(Math.abs(l - n) < 3 * Math.abs(m.dataInfo.minDiff) || n < m.minimum || l > m.maximum)) h.push(m), f.push({
                    val1: n,
                    val2: l
                }), k = !0;
                else if (!e) {
        ...
        if (k)
            for (g = 0; g < h.length; g++) m = h[g], a = f[g], m.setViewPortRange(a.val1, a.val2);
        return k
    };
    u.prototype.preparePlotArea = function() {
        ...
        this.axisX && b ? (a.x1 = this.axisX.lineCoordinates.x1 < this.axisX.lineCoordinates.x2 ? this.axisX.lineCoordinates.x1 : b.lineCoordinates.x1, a.y1 = this.axisX.lineCoordinates.y1 < b.lineCoordinates.y1 ? this.axisX.lineCoordinates.y1 : b.lineCoordinates.y1, a.x2 = this.axisX.lineCoordinates.x2 > b.lineCoordinates.x2 ? this.axisX.lineCoordinates.x2 : b.lineCoordinates.x2, a.y2 = this.axisX.lineCoordinates.y2 > this.axisX.lineCoordinates.y1 ? this.axisX.lineCoordinates.y2 : b.lineCoordinates.y2,
            a.width = a.x2 - a.x1, a.height = a.y2 - a.y1) : (b = this.layoutManager.getFreeSpace(), a.x1 = b.x1, a.x2 = b.x2, a.y1 = b.y1, a.y2 = b.y2, a.width = b.width, a.height = b.height);
    ...
    u.prototype.renderIndexLabels = function(a) {
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = f = e = 0, p = 0; p < this._indexLabels.length; p++) {
            var h = this._indexLabels[p],
                ...
                m, n, l = N("indexLabelFontColor", h.dataPoint, h.dataSeries),
                k = N("indexLabelFontSize", h.dataPoint, h.dataSeries);
            m = N("indexLabelFontFamily", h.dataPoint, h.dataSeries);
            n = N("indexLabelFontStyle", h.dataPoint, h.dataSeries);
            var f = N("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                d = N("indexLabelBackgroundColor",
                ...
                s = null;
            if (0 <= h.dataSeries.type.indexOf("stacked") || "pie" === h.dataSeries.type || "doughnut" === h.dataSeries.type) r = this.getPercentAndTotal(h.dataSeries, h.dataPoint);
            ...
            if (null !== w && "" !== w) {
                var c = N("indexLabelPlacement", h.dataPoint, h.dataSeries),
                    r = N("indexLabelOrientation", h.dataPoint,
                        h.dataSeries),
                    s = h.direction,
                ...
                if (0 <= g.indexOf("line") || 0 <= g.indexOf("area") || 0 <= g.indexOf("bubble") || 0 <= g.indexOf("scatter")) {
                    if (h.dataPoint.x < v.viewportMinimum || h.dataPoint.x > v.viewportMaximum || h.dataPoint.y <
                        x.viewportMinimum || h.dataPoint.y > x.viewportMaximum) continue
                } else if (h.dataPoint.x < v.viewportMinimum || h.dataPoint.x > v.viewportMaximum) continue;
                e = f = 2;
                "horizontal" === r ? (d = l.width, k = l.height) : (k = l.width, d = l.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    m = h.point.x - d / 2;
                    "inside" !== c ? (d = b.y1, e = b.y2, 0 < s ? (n = h.point.y - k - f, n < d && (n = "auto" === c ?
                        ...
                        f, b.y2 - k - f))), n = Math.min(n, e - k))
                } else 0 <= g.indexOf("line") || 0 <= g.indexOf("area") || 0 <= g.indexOf("scatter") ? (c = "auto", e = 4) : 0 <= g.indexOf("stacked") ? "auto" === c && (c = "inside") : "bubble" === g && (c = "inside"), n = h.point.y - k / 2, "inside" !== c ? (f = b.x1, g = b.x2, 0 > s ? (m = h.point.x - d - e, m < f && (m = "auto" === c ? Math.max(h.point.x, f) + e : f + e)) : (m = h.point.x + e, m > g - d - e && (m = "auto" === c ? Math.min(h.point.x, g) - d - e : g - d - e))) : (f = Math.max(h.bounds.x1, b.x1), Math.min(h.bounds.x2, b.x2), c = 0 <= g.indexOf("range") ? 0 > s ? Math.max(h.bounds.x1, b.x1) + d / 2 + e :
                    Math.min(h.bounds.x2, b.x2) - d / 2 - e : (Math.max(h.bounds.x1, b.x1) + Math.min(h.bounds.x2, b.x2)) / 2, m = 0 > s ? Math.max(h.point.x, c) - d / 2 : Math.min(h.point.x, c) - d / 2, m = Math.max(m, f));
                "vertical" === r && (n += k);
                l.x = m;
                l.y = n;
                l.render(!0)
    ...
    u.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                b.beginPath();
                if (0 < k.length) {
                    for (var q = !1, m = 0; m < k.length; m++)
                        if (n = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[m].y) 0 < m && (b.stroke(), t && c.stroke()), q = !0;
                            else {
                                ...
                                l = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[m].y - a.axisY.conversionParameters.minimum) +
                                    0.5 << 0;
                                var r = g.dataPointIds[m];
                                ...
                                h || q ? (b.beginPath(), b.moveTo(n, l), t && (c.beginPath(), c.moveTo(n, l)), q = h = !1) : (b.lineTo(n, l), t && c.lineTo(n, l), 0 == m % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, l), t && (c.stroke(), c.beginPath(), c.moveTo(n, l))));
                                if (0 < k[m].markerSize || 0 < g.markerSize) {
                                    var s = g.getMarkerProperties(m, n, l, b);
                                    d.push(s);
                                    r = B(r);
                                    t && d.push({
                                        x: n,
                                ...
                                }(k[m].indexLabel || g.indexLabel || k[m].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "line",
                                    dataPoint: k[m],
                                    dataSeries: g,
                                    point: {
    ...
    u.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < k.length) {
                    for (var q = !1, m = 0; m < k.length; m++)
                        if (n = k[m].getTime ? k[m].x.getTime() : k[m].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[m].y) 0 < m && (b.stroke(), t && c.stroke()), q = !0;
                            else {
                                var r = l;
                                n = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                l = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (k[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var s = g.dataPointIds[m];
                                ...
                                h || q ? (b.beginPath(), b.moveTo(n, l), t && (c.beginPath(), c.moveTo(n, l)), q = h = !1) : (b.lineTo(n, r), t && c.lineTo(n, r), b.lineTo(n, l), t && c.lineTo(n, l), 0 == m % 500 && (b.stroke(), b.beginPath(), b.moveTo(n, l), t && (c.stroke(), c.beginPath(), c.moveTo(n, l))));
                                if (0 < k[m].markerSize || 0 < g.markerSize) r = g.getMarkerProperties(m,
                                    n, l, b), d.push(r), s = B(s), t && d.push({
                                    x: n,
                                    y: l,
                                    ctx: c,
                                    type: r.type,
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length)
                    for (m = 0; m < p.length; m++)
                        if (n = p[m].getTime ? p[m].x.getTime() : p[m].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof p[m].y) 0 < m && (b(q), q = []);
                            else {
                                n = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                l = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (p[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var r = k.dataPointIds[m];
                                this._eventManager.objectMap[r] = {
                                    id: r,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: g,
                                ...
                                if (0 < p[m].markerSize || 0 < k.markerSize) {
                                    var s = k.getMarkerProperties(m, n, l, c);
                                    e.push(s);
                                    r = B(r);
                                    t && e.push({
                                        x: n,
                                ...
                                }(p[m].indexLabel || k.indexLabel || p[m].indexLabelFormatter ||
    ...
    var I = function(a, b, c, d, e, f, g, k, p, h, m, n, l) {
        ...
        a.globalAlpha = 1;
        0 < g && (l = 0 === g % 2 ? 0 : 0.5, a.beginPath(), a.lineWidth = g, a.strokeStyle = k, a.moveTo(b, c), a.rect(b - l, c - l, d - b + 2 * l, e - c + 2 * l), a.stroke());
        a.restore();
        ...
        !0 === m && (a.save(), a.beginPath(), a.moveTo(b, c), a.lineTo(b + q, c + q), a.lineTo(b + q, e - q), a.lineTo(b, e), a.closePath(), g = a.createLinearGradient(b + q, (e + c) / 2, b, (e + c) / 2), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === n && (a.save(),
    ...
    u.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            h = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(h) / a.plotType.totalDataSeries) << 0;
            h > e ? h = e : 1 > h && (h = 1);
            b.save();
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var m = a.dataSeriesIndexes[d],
                    ...
                    l = n.dataPoints;
                if (0 < l.length)
                    for (var q = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < l.length; e++)
                        if (l[e].getTime ? k = l[e].x.getTime() : k = l[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                            ...
                            0 <= l[e].y ? s = p : (s = g, g = p);
                            g > s && (s = g = s);
                            c = l[e].color ? l[e].color : n._colorSet[e % n._colorSet.length];
                            I(b, f, g, r, s, c, 0, null, q && 0 <= l[e].y, 0 > l[e].y && q, !1, !1, n.fillOpacity);
                            c = n.dataPointIds[e];
                            ...
                            (l[e].indexLabel || n.indexLabel || l[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "column",
                                dataPoint: l[e],
                                dataSeries: n,
                                point: {
    ...
    u.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                h = a.axisX.dataInfo.minDiff;
            isFinite(h) || (h = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            h = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            h > g ? h = g : 1 > h && (h = 1);
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
                ...
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            c = q[g].color ? q[g].color : l._colorSet[g % l._colorSet.length];
                            I(b, s, k, w, v, c, 0, null, r && 0 <= q[g].y, 0 > q[g].y && r, !1, !1, l.fillOpacity);
                            c = l.dataPointIds[g];
                            this._eventManager.objectMap[c] = {
                                id: c,
                                objectType: "dataPoint",
                            ...
                            (q[g].indexLabel ||
                                l.indexLabel || q[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
    ...
    u.prototype.renderStackedColumn100 =
        function(a) {
            var b = a.targetCanvasCtx || this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null,
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n = a.dataSeriesIndexes[m],
                        ...
                        q = l.dataPoints;
                    if (0 < q.length)
                        for (var r = 5 < h && l.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++)
                            if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin ||
    ...
    u.prototype.renderBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                h = a.axisX.dataInfo.minDiff;
            isFinite(h) || (h = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            h = 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(h) / a.plotType.totalDataSeries) << 0;
            h > e ? h = e : 1 > h && (h = 1);
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
    ...
    u.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                h = a.axisX.dataInfo.minDiff;
            isFinite(h) || (h = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            h = 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            h > g ? h = g : 1 > h && (h = 1);
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            k = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (q[g].y -
                                a.axisY.conversionParameters.minimum);
                            var s = d - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                w = s + h << 0,
                                v;
                            if (0 <= q[g].y) {
                            ...
                            c = q[g].color ? q[g].color : l._colorSet[g % l._colorSet.length];
                            I(b, v, s, k, w, c, 0, null, r, !1, !1, !1, l.fillOpacity);
                            c = l.dataPointIds[g];
                            this._eventManager.objectMap[c] = {
                                id: c,
                                objectType: "dataPoint",
    ...
    u.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            h = 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum -
                a.axisX.viewportMinimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            h > g ? h = g : 1 > h && (h = 1);
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ?
                            q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            k = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * ((0 !== a.dataPointYSums[c] ? 100 * (q[g].y / a.dataPointYSums[c]) : 0) - a.axisY.conversionParameters.minimum);
                            var s = d - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                w = s + h << 0,
    ...
    u.prototype.renderArea = function(a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                v = w : 0 > a.axisY.viewportMaximum ? v = f.y1 : 0 < a.axisY.viewportMinimum && (v = e.y2), c.lineTo(q, v), c.lineTo(x.x, v), c.closePath(), c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, t && (d.lineTo(q, v), d.lineTo(x.x, v), d.closePath(), d.fill()), c.beginPath(), c.moveTo(q, r), d.beginPath(), d.moveTo(q, r), x = {
                    x: q,
                    y: r
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < m.length) {
                    var E =
                        h._colorSet[l % h._colorSet.length];
                    c.fillStyle = E;
                    c.strokeStyle = E;
                    c.lineWidth = h.lineThickness;
                    c.setLineDash && c.setLineDash(M(h.lineDashType, h.lineThickness));
                    for (var y = !0; l < m.length; l++)
                        if (s = m[l].x.getTime ? m[l].x.getTime() : m[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof m[l].y) b(), y = !0;
                            else {
                                ...
                                r = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (m[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                n || y ? (c.beginPath(), c.moveTo(q, r), x = {
                                    x: q,
                                    y: r
                                }, t && (d.beginPath(), d.moveTo(q, r)), y = n = !1) : (c.lineTo(q, r), t && d.lineTo(q, r), 0 == l % 250 && b());
                                var z = h.dataPointIds[l];
                                ...
                                0 !== m[l].markerSize && (0 < m[l].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(l, q, r, c), g.push(s), z = B(z), t && g.push({
                                    x: q,
                                    y: r,
                                    ctx: d,
                                    type: s.type,
                                ...
                                (m[l].indexLabel || h.indexLabel || m[l].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "area",
                                    dataPoint: m[l],
                                    dataSeries: h,
                                    point: {
        ...
        function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (k = 0; k <
                    ...
                    var g = [],
                        n = 0,
                        l, q, r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
                        s, w = null,
                        v = [];
                    if (0 < m.length) {
                        ...
                        c.strokeStyle = color;
                        c.lineWidth = h.lineThickness;
                        for (c.setLineDash && c.setLineDash(M(h.lineDashType,
                                h.lineThickness)); n < m.length; n++)
                            if (l = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax))
                                if ("number" !== typeof m[n].y) 0 < n && (b(), v = []);
                                else {
                                    ...
                                    q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (m[n].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                    ...
                                    if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < h.markerSize)) {
                                        var E = h.getMarkerProperties(n, l, q, c);
                                        g.push(E);
                                        x = B(x);
                                        t && g.push({
                                            x: l,
                                    ...
                                    }(m[n].indexLabel || h.indexLabel || m[n].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
    ...
    u.prototype.renderStepArea = function(a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = w : 0 > a.axisY.viewportMaximum ? v = f.y1 : 0 < a.axisY.viewportMinimum && (v = e.y2), c.lineTo(q, v), c.lineTo(x.x, v), c.closePath(), c.globalAlpha = h.fillOpacity,
                c.fill(), c.globalAlpha = 1, t && (d.lineTo(q, v), d.lineTo(x.x, v), d.closePath(), d.fill()), c.beginPath(), c.moveTo(q, r), d.beginPath(), d.moveTo(q, r), x = {
                    x: q,
                    y: r
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                var g = [],
                    ...
                    E = !1;
                if (0 < m.length) {
                    var y = h._colorSet[l % h._colorSet.length];
                    c.fillStyle = y;
                    c.strokeStyle = y;
                    c.lineWidth = h.lineThickness;
                    for (c.setLineDash && c.setLineDash(M(h.lineDashType, h.lineThickness)); l <
                        m.length; l++)
                        if (s = m[l].x.getTime ? m[l].x.getTime() : m[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                            var z = r;
                            "number" !== typeof m[l].y ? (b(), E = !0) : (q = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) + 0.5 << 0, r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (m[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n || E ? (c.beginPath(), c.moveTo(q, r), x = {
                                    x: q,
                                    y: r
                                }, t && (d.beginPath(), d.moveTo(q,
                                    r)), E = n = !1) : (c.lineTo(q, z), t && d.lineTo(q, z), c.lineTo(q, r), t && d.lineTo(q, r), 0 == l % 250 && b()), z = h.dataPointIds[l], this._eventManager.objectMap[z] = {
                                    id: z,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: p,
                                    dataPointIndex: l,
                                    ...
                                    borderColor: z,
                                    borderThickness: s.borderThickness
                                })), (m[l].indexLabel || h.indexLabel || m[l].indexLabelFormatter || h.indexLabelFormatter) &&
    ...
    u.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = [],
                k = 0,
                p, h, m, n = a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
            ...
            b.clip();
            t && (l.beginPath(), l.rect(e.x1, e.y1, e.width, e.height), l.clip());
            xValuePresent = [];
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                var q = a.dataSeriesIndexes[e],
                    ...
                    s = r.dataPoints;
                r.dataPointIndexes = [];
                for (k = 0; k < s.length; k++) q = s[k].x.getTime ? s[k].x.getTime() : s[k].x, r.dataPointIndexes[q] =
                    k, xValuePresent[q] || (g.push(q), xValuePresent[q] = !0);
                g.sort(ta)
            }
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                var q = a.dataSeriesIndexes[e],
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        m = g[k];
                        var x = null,
                            x = 0 <= r.dataPointIndexes[m] ?
                            s[r.dataPointIndexes[m]] : {
                                x: m,
                                y: 0
                            };
                        if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && "number" === typeof x.y) {
                            p = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (m - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            f[m] = n - h;
                            if (w) b.beginPath(), b.moveTo(p, h), t && (l.beginPath(), l.moveTo(p, h)),
                                w = !1;
                            else if (b.lineTo(p, h), t && l.lineTo(p, h), 0 == k % 250) {
                                ...
                                b.beginPath();
                                b.moveTo(p, h);
                                t && (l.closePath(), l.fill(), l.beginPath(), l.moveTo(p, h));
                                v.push({
                                    x: p,
                                    y: n - E
                                })
                            }
                            if (0 <= r.dataPointIndexes[m]) {
                                var z = r.dataPointIds[r.dataPointIndexes[m]];
                                this._eventManager.objectMap[z] = {
                                    id: z,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: q,
                                    dataPointIndex: r.dataPointIndexes[m],
                                    x1: p,
                                    y1: h
                                }
                            }
                            0 <= r.dataPointIndexes[m] && 0 !== x.markerSize && (0 < x.markerSize || 0 < r.markerSize) && (m = r.getMarkerProperties(k, p, h, b), d.push(m), markerColor = B(z), t && d.push({
                                x: p,
                                y: h,
                                ctx: l,
                                type: m.type,
                    ...
                    for (0 < r.lineThickness &&
                        b.stroke(); 0 < v.length;) y = v.pop(), b.lineTo(y.x, y.y), t && l.lineTo(y.x, y.y);
                    b.closePath();
                    b.globalAlpha = r.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    u.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = [],
                k = 0,
                p, h, m, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                l = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0,
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        m = g[k];
                        var y = null,
                            y = 0 <= w.dataPointIndexes[m] ? v[w.dataPointIndexes[m]] : {
                                x: m,
                                y: 0
                            };
                        if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && "number" === typeof y.y) {
                            h = 0 !== a.dataPointYSums[m] ? 100 * (y.y / a.dataPointYSums[m]) :
                                0;
                            p = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (m - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            if (0 <= w.dataPointIndexes[m]) {
                                var D = w.dataPointIds[w.dataPointIndexes[m]];
                                this._eventManager.objectMap[D] = {
                                    id: D,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: s,
                                    dataPointIndex: w.dataPointIndexes[m],
                                    x1: p,
                                    y1: h
                                }
                            }
                            0 <= w.dataPointIndexes[m] && 0 !== y.markerSize && (0 < y.markerSize || 0 < w.markerSize) && (m = w.getMarkerProperties(k,
                                p, h, b), e.push(m), markerColor = B(D), t && e.push({
                                x: p,
                                y: h,
                                ctx: r,
                                type: m.type,
    ...
    u.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea,
                e = 0,
                f, g, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 *
                this.width << 0,
            ...
            b.clip();
            t && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, h = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++)
                for (var n = a.dataSeriesIndexes[m], l = this.data[n], q = l.dataPoints, r = 0, e = 0; e < q.length; e++) f = q[e].getTime ?
                    f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (r = q[e].z, r > p && (p = r), r < h && (h = r));
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), m = 0; m < a.dataSeriesIndexes.length; m++)
                if (n = a.dataSeriesIndexes[m], l = this.data[n], q = l.dataPoints, 1 == q.length && (c = k), 1 > c ? c = 1 : c > k && (c = k), 0 < q.length)
    ...
    u.prototype.renderScatter = function(a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea,
                ...
                e = a.axisX.dataInfo.minDiff,
                c = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum -
                    a.axisX.viewportMinimum) * Math.abs(e) / c) << 0;
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var l = 0, q = 0, e = 0; e < n.length; e++)
                        if (f =
                            n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                            f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (f - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            var r = m.getMarkerProperties(e, f, g, b);
                            b.globalAlpha = m.fillOpacity;
                            K.drawMarker(r.x, r.y, r.ctx, r.type, r.size,
                                r.color, r.borderColor, r.borderThickness);
                            b.globalAlpha = 1;
                            Math.sqrt((l - f) * (l - f) + (q - g) * (q - g)) < Math.min(r.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (l = m.dataPointIds[e], this._eventManager.objectMap[l] = {
                                id: l,
                                objectType: "dataPoint",
                                dataSeriesIndex: h,
                                dataPointIndex: e,
                                x1: f,
                                y1: g
                            }, l = B(l), t && K.drawMarker(r.x, r.y, this._eventManager.ghostCtx, r.type, r.size, l, l, r.borderThickness), (n[e].indexLabel || m.indexLabel || n[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: n[e],
                                dataSeries: m,
                                point: {
    ...
    u.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                d = this.plotArea,
                e = 0,
                f, g, k, p, h, m, e = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.015 * this.width,
                n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            n = 0.7 * d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(n) << 0;
            n > e ? n = e : 1 > n && (n = 1);
            b.save();
            t && c.save();
            b.beginPath();
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < s.length)
                    for (var w = 5 < n && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? m = s[e].x.getTime() : m = s[e].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                            f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (m - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            h = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (s[e].y[3] - a.axisY.conversionParameters.minimum) +
                                0.5 << 0;
                            var v = f - n / 2 << 0,
                                x = v + n << 0,
                            ...
                            "candlestick" === r.type ? (b.moveTo(f - u, k), b.lineTo(f - u, Math.min(g, h)), b.stroke(), b.moveTo(f - u, Math.max(g, h)), b.lineTo(f - u, p), b.stroke(),
                                ...
                                u, k), c.lineTo(f - u, p), c.stroke(), c.beginPath(), c.moveTo(f, g), c.lineTo(v, g), c.stroke(), c.beginPath(), c.moveTo(f, h), c.lineTo(x, h), c.stroke()));
    ...
    u.prototype.renderRangeColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            k = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(k) / a.plotType.totalDataSeries) << 0;
            k > e ? k = e : 1 > k && (k = 1);
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = a.dataSeriesIndexes[p],
                    ...
                    n = m.dataPoints;
                if (0 < n.length)
                    for (var l = 5 < k && m.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)
                        if (n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] &&
                            ...
                            var q = c - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                    p) * k << 0,
                                r = q + k << 0,
                            ...
                            I(b, q, d, r, f, c, 0, c, l, l, !1, !1, m.fillOpacity);
                            c = B(s);
    ...
    u.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            p = 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) *
                Math.abs(p) / a.plotType.totalDataSeries) << 0;
            p > e ? p = e : 1 > p && (p = 1);
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
                ...
                if (0 < l.length) {
                    ...
                    for (e = 0; e < l.length; e++)
                        if (l[e].getTime ? k = l[e].x.getTime() :
                            k = l[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== l[e].y && l[e].y.length && "number" === typeof l[e].y[0] && "number" === typeof l[e].y[1]) {
                            ...
                            if (l[e].indexLabel || n.indexLabel || l[e].indexLabelFormatter ||
                ...
                if (0 < h.length) {
                    ...
                    for (var x = !0; n < h.length; n++)
                        if (s = h[n].x.getTime ? h[n].x.getTime() : h[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null !== h[n].y && h[n].y.length && "number" === typeof h[n].y[0] &&
                                "number" === typeof h[n].y[1]) {
                                l = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                ...
                                m || x ? (c.beginPath(), c.moveTo(l, q), w = {
                                    x: l,
                                    y: q
                                }, g = [], g.push({
                                    x: l,
                                    y: r
                                }), t && (d.beginPath(), d.moveTo(l, q)), x = m = !1) : (c.lineTo(l, q), g.push({
                                    x: l,
                                    y: r
                                }), t && d.lineTo(l, q), 0 == n % 250 && b());
                                s = p.dataPointIds[n];
                                this._eventManager.objectMap[s] = {
                                    id: s,
                                    objectType: "dataPoint",
                                ...
                                if (0 !== h[n].markerSize && (0 < h[n].markerSize || 0 < p.markerSize)) {
                                    var u = p.getMarkerProperties(n, l, r, c);
                                    e.push(u);
                                    var y = B(s);
                                    t && e.push({
                                        x: l,
                                    ...
                                    u = p.getMarkerProperties(n, l, q, c);
                                    e.push(u);
                                    y = B(s);
                                    t && e.push({
                                        x: l,
                                ...
                                if (h[n].indexLabel || p.indexLabel || h[n].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeArea",
                                    dataPoint: h[n],
                                    dataSeries: p,
                                    indexKeyword: 0,
    ...
    u.prototype.renderRangeSplineArea = function(a) {
        function b() {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3) c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), t && d.bezierCurveTo(a[b + 1].x,
                ...
                if (0 < k.lineThickness) {
                    ...
                    for (b = a.length - 1; 2 < b; b -= 3) c.bezierCurveTo(a[b - 1].x, a[b - 1].y,
                        a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y), t && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y);
                    c.stroke()
                }
                c.beginPath();
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length) {
                    ...
                    for (c.setLineDash && c.setLineDash(M(k.lineDashType, k.lineThickness)); h < p.length; h++)
                        if (m = p[h].x.getTime ? p[h].x.getTime() : p[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
                            if (null !== p[h].y && p[h].y.length &&
                                "number" === typeof p[h].y[0] && "number" === typeof p[h].y[1]) {
                                ...
                                l = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[h].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                ...
                                if (0 !== p[h].markerSize && (0 < p[h].markerSize || 0 < k.markerSize)) {
                                    var w = k.getMarkerProperties(h, m, n, c);
                                    e.push(w);
                                    var v = B(s);
                                    t && e.push({
                                        x: m,
                                    ...
                                    w = k.getMarkerProperties(h, m, l, c);
                                    e.push(w);
                                    v = B(s);
                                    t && e.push({
                                        x: m,
                                ...
                                if (p[h].indexLabel ||
                                    k.indexLabel || p[h].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "splineArea",
                                    dataPoint: p[h],
                                    dataSeries: k,
                                    indexKeyword: 0,
    ...
    var ra = function(a, b, c, d, e, f, g, k, p) {
        ...
        a.save();
        a.globalAlpha = k;
        "pie" === e ? (a.beginPath(), a.moveTo(b.x, b.y), a.arc(b.x, b.y, c, f, g, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(b.x, b.y, c, f, g, !1), a.arc(b.x, b.y, p * c, g, f, !0), a.closePath(),
    ...
    u.prototype.renderPie = function(a) {
        function b() {
            if (h && m) {
                ...
                for (y = 0; y < m.length; y++) {
                    ...
                    if (h.indexLabelFormatter || e.indexLabelFormatter) n = {
                        chart: p._options,
                        dataSeries: h,
                        dataPoint: e,
                        total: k.total,
                    ...
                    k = e.indexLabelFormatter ?
                        e.indexLabelFormatter(n) : e.indexLabel ? p.replaceKeywordsWithValue(e.indexLabel, e, h, y) : h.indexLabelFormatter ? h.indexLabelFormatter(n) : h.indexLabel ? p.replaceKeywordsWithValue(h.indexLabel, e, h, y) : e.label ? e.label : "";
                    ...
                    g.indexLabelLineColor = e.indexLabelLineColor ? e.indexLabelLineColor : h.indexLabelLineColor ? h.indexLabelLineColor : e.color ? e.color : h._colorSet[y %
                        h._colorSet.length];
                    ...
                    g.indexLabelFontSize =
                        e.indexLabelFontSize ? e.indexLabelFontSize : h.indexLabelFontSize;
                    ...
                    g.indexLabelMaxWidth = e.indexLabelMaxWidth ? e.indexLabelMaxWidth : h.indexLabelMaxWidth ? h.indexLabelMaxWidth : 0.33 * l.width;
                    ...
                    if (g.midAngle > Math.PI / 2 - t && g.midAngle < Math.PI / 2 + t) {
                        ...
                        if (0 === b || q[d].midAngle > g.midAngle) d = y;
                        b++
                    }
                    g.hemisphere = e > Math.PI / 2 && e <= 3 * Math.PI / 2 ? "left" : "right";
                    g.indexLabelTextBlock =
                        new H(p.plotArea.ctx, {
                ...
                f = e = 0;
                k = !1;
                for (y = 0; y < m.length; y++) g = q[(c + y) % m.length], 1 <
                    a && (g.midAngle > Math.PI / 2 - t && g.midAngle < Math.PI / 2 + t) && (e <= a / 2 && !k ? (g.hemisphere = "right", e++) : (g.hemisphere = "left", k = !0));
                k = !1;
                for (y = 0; y < m.length; y++) g = q[(d + y) % m.length], 1 < b && (g.midAngle > 3 * Math.PI / 2 - t && g.midAngle < 3 * Math.PI / 2 + t) && (f <= b / 2 && !k ? (g.hemisphere = "left", f++) : (g.hemisphere = "right", k = !0))
            }
        }
        ...
        function c(a) {
            ...
            for (b = 0; b < m.length; b++) {
                ...
                if (d > c) {
                    ...
                    ra(p.plotArea.ctx, q[b].center, q[b].radius, m[b].color ?
                        m[b].color : h._colorSet[b % h._colorSet.length], h.type, c, d, h.fillOpacity, q[b].percentInnerRadius)
                }
            }
            a = p.plotArea.ctx;
            a.fillStyle = "black";
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < m.length; b++) c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== h.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== h.indexLabelPlacement ? n : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x +=
                d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && (d = c.center.x + z * Math.cos(c.midAngle), e = c.center.y + z * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(M(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x +
                    ("left" === c.hemisphere ? -n : n), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter")
        }
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < m.length) {
                ...
                0 > b ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height /
                    2 > h && l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b < h && (b = -(h - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b))) : l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 < h && l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b > k && (b = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b - k);
                b = l.indexLabelTextBlock.y + b;
                h = 0;
                h = "right" === l.hemisphere ? x.x + Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(b - x.y, 2)) : x.x - Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(b - x.y, 2));
                p = x.x +
                    z * Math.cos(l.midAngle);
                n = x.y + z * Math.sin(l.midAngle);
                ...
                for (k = 1; k < m.length; k++)
                    if (h = (a - k + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) {
                        h = null;
                        break
                    } else if (q[h].indexLabelText && q[h].hemisphere === q[a].hemisphere && h !== a && (0 > d(q[h], q[a]) || ("right" === q[a].hemisphere ? q[h].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y :
                        q[h].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y))) break;
                else h = null;
                p = h;
                n = e(a);
                k = h = 0;
                0 > b ? (k = "right" === l.hemisphere ? p : n, g = b, null !== k && (p = -b, b = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - (q[k].indexLabelTextBlock.y + q[k].indexLabelTextBlock.height / 2), b - p < r && (h = -p, k = f(k, h, c + 1), +k.toFixed(v) > +h.toFixed(v) && (g = b > r ? -(b - r) : -(p - (k - h)))))) : 0 < b && (k = "right" === l.hemisphere ? n : p, g = b, null !== k && (p = b, b = q[k].indexLabelTextBlock.y - q[k].indexLabelTextBlock.height / 2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height /
                    2), b - p < r && (h = p, k = f(k, h, c + 1), +k.toFixed(v) < +h.toFixed(v) && (g = b > r ? b - r : p - (h - k)))));
                g && (c = l.indexLabelTextBlock.y + g, b = 0, b = "right" === l.hemisphere ? x.x + Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(c - x.y, 2)) : x.x - Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(c - x.y, 2)), l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t ? (h = (a - 1 + q.length) % q.length, h = q[h], a = q[(a + 1 + q.length) % q.length], "left" === l.hemisphere && "right" === h.hemisphere && b > h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x - 15 : "right" === l.hemisphere &&
                    ...
                    x.y, l.indexLabelTextBlock.x - x.x))
            }
            return g
        }
        ...
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                if ("inside" !== h.indexLabelPlacement) {
                    ...
                    for (a = 0; a < m.length; a++) {
                        ...
                        k.indexLabelTextBlock.y =
                            x.y + indexLabelRadius * Math.sin(k.midAngle);
                        k.indexLabelAngle = k.midAngle;
                        k.radius = z;
                        k.percentInnerRadius = D
                    }
                    for (var t, w, a = 0; a < m.length; a++) {
                        var k = q[a],
                            u = e(a);
                        if (null !== u) {
                            t = q[a];
                            ...
                            var y = 0,
                                y = d(t, w) - r;
                            if (0 > y) {
                                for (var B = w = 0, C = 0; C < m.length; C++) C !== a && q[C].hemisphere === k.hemisphere && (q[C].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? w++ : B++);
                                w = y / (w + B || 1) * B;
                                var B = -1 * (y - w),
                                    E = C = 0;
                                "right" === k.hemisphere ? (C = f(a, w), B = -1 * (y - C), E = f(u, B), +E.toFixed(v) < +B.toFixed(v) && +C.toFixed(v) <= +w.toFixed(v) && f(a, -(B - E))) :
                                    (C = f(u, w), B = -1 * (y - C), E = f(a, B), +E.toFixed(v) < +B.toFixed(v) && +C.toFixed(v) <= +w.toFixed(v) && f(u, -(B - E)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < m.length; a++) k = q[a], indexLabelRadius = "pie" === h.type ? 0.7 * z : 0.8 * z, u = x.x + indexLabelRadius * Math.cos(k.midAngle), w = x.y + indexLabelRadius * Math.sin(k.midAngle), k.indexLabelTextBlock.x = u, k.indexLabelTextBlock.y = w;
                for (a = 0; a < m.length; a++)
                    if (k = q[a], u = k.indexLabelTextBlock.measureText(), 0 !== u.height && 0 !== u.width) u = u = 0, "right" === k.hemisphere ? (u = l.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width +
                ...
                (function() {
                    for (var a = -1, b = -1, c = 0, f = !1, g = 0; g < m.length; g++)
                        if (f = !1, t = q[g], t.indexLabelText) {
                            ...
                            if (null !== h) {
                                ...
                                if (l = 0 > y) {
                                    ...
                                    l = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < k.indexLabelTextBlock.x - n || l > w + n || p > v + n || r < s - n ? !1 : !0
                                }
                                l ? (0 > a && (a = g), h !== a && (b = h, c += -y), 0 === g % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== u) {
                ...
                var z = "inside" !== h.indexLabelPlacement &&
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0,
                    function(a) {
                        var b = p.plotArea.ctx;
                        b.clearRect(l.x1, l.y1, l.width, l.height);
                        b.fillStyle = p.backgroundColor;
                        ...
                        for (b = 0; b < m.length; b++) {
                            var c = 0 === b ? q[b].startAngle : d,
                                ...
                                e = !1;
                            d > a && (d = a, e = !0);
                            var f = m[b].color ? m[b].color : h._colorSet[b % h._colorSet.length];
                    ...
                    function() {
                        p.disableToolTip = !1;
                        p._animator.animate(0,
                            p.animatedRender ? 500 : 0,
                            function(a) {
                                c(a);
                                k()
                            })
    ...
    H.prototype.render = function(a) {
        ...
        for (c = 0; c < this._wrappedText.lines.length; c++) f = this._wrappedText.lines[c],
            "right" === this.horizontalAlign ? d = this.width - f.width - this.padding : "left" === this.horizontalAlign ? d = this.padding : "center" === this.horizontalAlign && (d = (this.width - 2 * this.padding) / 2 - f.width / 2 + this.padding), this.ctx.fillText(f.text, d, e), e += f.height;
        this.ctx.font = b;
        a && this.ctx.restore()
    };
    ...
    H.prototype._getLineWithWidth = function(a, b, c) {
        ...
        b && (a = g.split(" "), 1 < a.length &&
            a.pop(), g = a.join(" "), c = this.ctx.measureText(g).width);
        return {
            text: g,
            width: c
        }
    ...
    aa.prototype.render = function() {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = b.width - 4 - g * ("center" === this.horizontalAlign ? 2 : 1)), f = 0.5 * b.height - this.margin - 2, e = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = b.height - 4), f = 0.5 * b.width - this.margin - 2) : "center" === this.horizontalAlign && (null ===
                this.maxWidth && (this.maxWidth = b.width - 4), f = 0.5 * b.height - 4));
    ...
    ja.prototype.render = function() {
        ...
        "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal",
            c = this.verticalAlign, f = null !== this.maxWidth ? this.maxWidth : 0.7 * b.width, g = null !== this.maxHeight ? this.maxHeight : 0.5 * b.height) : "center" === this.verticalAlign && (this.orientation = "vertical", c = this.horizontalAlign, f = null !== this.maxWidth ? this.maxWidth : 0.5 * b.width, g = null !== this.maxHeight ? this.maxHeight : 0.7 * b.height);
        for (var h = 0; h < this.dataSeries.length; h++) {
            var m = this.dataSeries[h];
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var n = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !==
                    m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? S.getDefaultLegendMarker(m.type) : m.markerType,
                    l = m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                        chart: this.chart,
                        legend: this._options,
                        dataSeries: m,
                        dataPoint: null
                    }) : m.name,
                    q = m.legendMarkerColor ? m.legendMarkerColor : m.markerColor ? m.markerColor : m._colorSet[0],
                    r = m.markerSize || "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type ? 0.6 * this.lineHeight : 0,
                    s = m.legendMarkerBorderColor ? m.legendMarkerBorderColor :
                    m.markerBorderColor,
                    t = m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : m.markerBorderThickness ? Math.max(1, Math.round(0.2 * r)) : 0,
                    l = this.chart.replaceKeywordsWithValue(l, m.dataPoints[0], m, h),
                    n = {
                        markerType: n,
                        markerColor: q,
                        text: l,
                ...
                for (var v = 0; v < m.dataPoints.length; v++) {
                    var u = m.dataPoints[v],
                        n = u.legendMarkerType ? u.legendMarkerType :
                        m.legendMarkerType ? m.legendMarkerType : S.getDefaultLegendMarker(m.type),
                        l = u.legendText ? u.legendText : m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this._options,
                            dataSeries: m,
                            dataPoint: u
                        }) : u.name ? u.name : "DataPoint: " + (v + 1),
                        q = u.legendMarkerColor ? u.legendMarkerColor : m.legendMarkerColor ? m.legendMarkerColor : u.color ? u.color : m.color ? m.color : m._colorSet[v % m._colorSet.length],
                        r = 0.6 * this.lineHeight,
                        s = u.legendMarkerBorderColor ? u.legendMarkerBorderColor : m.legendMarkerBorderColor ?
                        m.legendMarkerBorderColor : u.markerBorderColor ? u.markerBorderColor : m.markerBorderColor,
                        t = u.legendMarkerBorderThickness ? u.legendMarkerBorderThickness : m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : u.markerBorderThickness || m.markerBorderThickness ? Math.max(1, Math.round(0.2 * r)) : 0,
                        l = this.chart.replaceKeywordsWithValue(l, u, m, v),
                        n = {
                            markerType: n,
                            markerColor: q,
                            text: l,
                    ...
                    (u.showInLegend ||
                        m.showInLegend && !1 !== u.showInLegend) && k.push(n)
                }
        }!0 === this.reversed && k.reverse();
        if (0 < k.length) {
            m = null;
            v = l = u = 0;
            l = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : f;
            r = 0 === r ? 0.6 * this.lineHeight : r;
            l -= r + 0.1 * this.horizontalSpacing;
            for (h = 0; h < k.length; h++) {
                n = k[h];
                if ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType) l -= 2 * 0.1 * this.lineHeight;
                if (!(0 >= g || "undefined" ===
                        typeof g || 0 >= l || "undefined" === typeof l)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + 0.1 * this.horizontalSpacing + ("line" === n.chartType || "spline" ===
                            n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                        if (!m || m.width + Math.round(n.textBlock.width + 0.1 * this.horizontalSpacing + r + (0 === m.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) m = {
                            items: [],
                            width: 0
                        }, p.push(m), this.height += v, v = 0;
                        ...
                        fontStyle: this.fontStyle,
                        textBaseline: "top"
                    }), n.textBlock.measureText(), null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + 0.1 * this.horizontalSpacing + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height <= g ? (m = {
                        items: [],
                        width: 0
                    }, p.push(m)) : (m = p[u], u = (u + 1) % p.length), this.height += n.textBlock.height;
                    n.textBlock.x = m.width;
                    n.textBlock.y =
                        0;
                    m.width += Math.round(n.textBlock.width + 0.1 * this.horizontalSpacing + r + (0 === m.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0));
                    m.items.push(n);
        ...
        this.items = k;
        for (h = 0; h < this.items.length; h++) n = k[h], n.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[n.id] = {
            id: n.id,
        ...
        for (h = b = 0; h < p.length; h++) {
            m = p[h];
            for (k = v = 0; k < m.items.length; k++) {
                n = m.items[k];
                l = n.textBlock.x + e + (0 === k ? 0.2 * r : this.horizontalSpacing);
                q = d + b;
                u = l;
                ...
                if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType) this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth =
                    Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(l - 0.1 * this.lineHeight, q + this.lineHeight / 2), this.ctx.lineTo(l + 0.7 * this.lineHeight, q + this.lineHeight / 2), this.ctx.stroke(), u -= 0.1 * this.lineHeight;
                K.drawMarker(l + r / 2, q + this.lineHeight / 2, this.ctx, n.markerType, n.markerSize, n.markerColor, n.markerBorderColor, n.markerBorderThickness);
                n.textBlock.x = l + 0.1 * this.horizontalSpacing + r;
    ...
    S.prototype.getDataPointAtX = function(a, b) {
        ...
        var c = {
            ...
            h = 0,
            m = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (m = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, m = 0 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * (a - this.dataPoints[0].x) >>
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (l) {
                    switch (this.type) {
                        ...
                        case "rangeBar":
                            a >=
                                l.x1 && (a <= l.x2 && b >= l.y1 && b <= l.y2) && (d.push({
                                    dataPoint: q,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: Math.min(Math.abs(l.x1 - a), Math.abs(l.x2 - a), Math.abs(l.y1 - b), Math.abs(l.y2 - b))
                                }), k = !0);
                            break;
                        case "line":
                        case "stepLine":
                        ...
                        case "scatter":
                            var s = N("markerSize", q, this) || 4,
                                t = c ? 20 : s,
                                r = Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - b, 2));
                            r <= t && d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                        ...
                        case "rangeSplineArea":
                            ...
                            t = c ? 20 : s;
                            r = Math.min(Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - b, 2)), Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y2 - b, 2)));
                            r <= t && d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                        ...
                        case "doughnut":
                            ...
                            r < l.radius && r > t && (r = Math.atan2(b - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (l.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), t = Number(((180 * (l.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === t && 1 < l.endAngle && (t = 360), s >= t && 0 !== q.y && (t += 360, r < s && (r += 360)), r > s && r < t && (d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                                distance: 0
                            ...
                            break;
                        case "candlestick":
                            if (a >= l.x1 - l.borderThickness / 2 && a <= l.x2 + l.borderThickness / 2 && b >= l.y2 - l.borderThickness / 2 && b <= l.y3 + l.borderThickness / 2 || Math.abs(l.x2 - a + l.x1 - a) < l.borderThickness && b >= l.y1 && b <= l.y4) d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                                distance: Math.min(Math.abs(l.x1 - a), Math.abs(l.x2 - a), Math.abs(l.y2 - b), Math.abs(l.y3 - b))
                            }), k = !0;
                            break;
                        case "ohlc":
                            if (Math.abs(l.x2 - a + l.x1 - a) < l.borderThickness && b >= l.y2 && b <= l.y3 || a >= l.x1 && a <= (l.x2 +
                                    l.x1) / 2 && b >= l.y1 - l.borderThickness / 2 && b <= l.y1 + l.borderThickness / 2 || a >= (l.x1 + l.x2) / 2 && a <= l.x2 && b >= l.y4 - l.borderThickness / 2 && b <= l.y4 + l.borderThickness / 2) d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                                distance: Math.min(Math.abs(l.x1 - a), Math.abs(l.x2 - a), Math.abs(l.y2 - b), Math.abs(l.y3 - b))
    ...
    C.prototype.createLabels = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) b = this.lineCoordinates.width / Math.abs(this.viewportMaximum - this.viewportMinimum) * this.interval, d = this.labelAutoFit ? "undefined" === typeof this._options.labelMaxWidth ? 0.9 * b >> 0 : this.labelMaxWidth : "undefined" === typeof this._options.labelMaxWidth ? 0.7 * this.chart.width >> 0 : this.labelMaxWidth, e = "undefined" === typeof this._options.labelWrap ||
            this.labelWrap ? 0.5 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c = sa(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < c; sa(b, this.interval, this.intervalType)) a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this._options,
                value: b,
                label: this.labels[b] ? this.labels[b] : null
            }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : qa(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
            ...
            if (this.labels && this.labels.length) {
                ...
                for (var f = Math.ceil(this.intervalStartPosition), g = !1, b = f; b < this.viewportMaximum; b +=
                    a)
            ...
            for (b = this.intervalStartPosition; b <= c; b = parseFloat((b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this._options,
                value: b,
                label: this.labels[b] ? this.labels[b] : null
            }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : W(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
    ...
    C.prototype.createLabelsAndCalculateWidth = function() {
        ...
        if ("left" === this._position || "right" === this._position)
            for (this.createLabels(), i = 0; i < this._labels.length; i++) {
                var b =
                    this._labels[i].textBlock.measureText(),
                    c = 0,
    ...
    C.setLayoutAndRender = function(a, b, c, d, e) {
        ...
        if ("normal" === d) {
            ...
            f = Math.round(e.x1 + n + m);
            a.lineCoordinates.x1 = f;
            m = Math.ceil(c ? c.createLabelsAndCalculateWidth() : 0);
            g = Math.round(e.x2 - m > a.chart.width - 10 ? a.chart.width - 10 : e.x2 - m);
            a.lineCoordinates.x2 = g;
            a.lineCoordinates.width = Math.abs(g - f);
            var l = Math.ceil(a.createLabelsAndCalculateHeight());
            d = Math.round(e.y2 - l - a.margin);
            ...
            b && (f = Math.round(e.x1 + b.margin), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + n + b.margin), k = Math.round(e.y2 - l - a.margin), b.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
                y2: k,
            ...
            c && (f = Math.round(a.lineCoordinates.x2), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(f + m + c.margin), k = Math.round(e.y2 - l - a.margin), c.lineCoordinates = {
                x1: f,
                y1: d,
                x2: f,
                y2: k,
            ...
            b && (b.lineCoordinates = {}, f = Math.round(e.x1 + n + a.margin), g = Math.round(e.x2 >
                b.chart.width - 10 ? b.chart.width - 10 : e.x2), b.lineCoordinates.x1 = f, b.lineCoordinates.x2 = g, b.lineCoordinates.width = Math.abs(g - f));
            c && (c.lineCoordinates = {}, f = Math.round(e.x1 + n + a.margin), g = Math.round(e.x2 > c.chart.width - 10 ? c.chart.width - 10 : e.x2), c.lineCoordinates.x1 = f, c.lineCoordinates.x2 = g, c.lineCoordinates.width = Math.abs(g - f));
            var l = Math.ceil(b ? b.createLabelsAndCalculateHeight() : 0),
                q = Math.ceil(c ? c.createLabelsAndCalculateHeight() : 0);
            b && (d = Math.round(e.y2 - l - b.margin), k = Math.round(e.y2 - m > b.chart.height - 10 ?
                b.chart.height - 10 : e.y2 - m), b.lineCoordinates.y1 = d, b.lineCoordinates.y2 = d, b.boundingRect = {
                x1: f,
                y1: d,
                x2: g,
                y2: k,
            ...
            k = Math.round(b ? b.lineCoordinates.y1 : e.y2 - m > a.chart.height - 10 ? a.chart.height - 10 : e.y2 - m);
            a.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
    ...
    C.prototype.renderLabelsTicksAndTitle = function() {
        ...
        if ("undefined" === typeof this._options.interval) {
            if ("bottom" === this._position || "top" === this._position) {
                for (e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum || f.stripLine || (f = f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.height * Math.sin(Math.PI / 180 * this.labelAngle), b += f);
                b > this.lineCoordinates.width * c && (a = !0)
            }
            if ("left" === this._position || "right" === this._position) {
                for (e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum ||
                    f.stripLine || (f = f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), b += f);
        ...
        if ("bottom" === this._position) {
            for (var e = 0, f, e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.viewportMinimum || f.position > this.viewportMaximum)) {
                    ...
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType) this._labels[e].stripLine ?
                        (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(), this.ctx.moveTo(c, b.y << 0), this.ctx.lineTo(c, b.y + this.tickLength << 0), this.ctx.stroke();
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine) 0 === f.textBlock.angle ? (b.x -= f.textBlock.width / 2, b.y += this.tickLength + f.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? f.textBlock.width * Math.cos(Math.PI /
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.viewportMinimum || f.position > this.viewportMaximum)) {
                    ...
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine) 0 ===
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.viewportMinimum ||
                    ...
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType) this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0, this.ctx.beginPath(), this.ctx.moveTo(b.x << 0, c), this.ctx.lineTo(b.x -
                        this.tickLength << 0, c), this.ctx.stroke();
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine) f.textBlock.x = b.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5, f.textBlock.y = 0 === this.labelAngle ? b.y : b.y - f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), f.textBlock.render(!0)
                }
            this.title && (this._titleTextBlock = new H(this.ctx, {
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.viewportMinimum || f.position > this.viewportMaximum)) {
                    b =
                        this.getPixelCoordinatesOnAxis(f.position);
    ...
    C.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) this._labels[e].stripLine || (b ? (b = this.getPixelCoordinatesOnAxis(this._labels[e].position),
                c = e + 1 >= this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(b.x, d.y1, Math.abs(c.x - b.x), Math.abs(d.y1 - d.y2)), b = !1) : b = !0);
        else if (("left" === this._position || "right" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) this._labels[e].stripLine || (b ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), b = e + 1 >= this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) :
    ...
    C.prototype.renderGrid = function() {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                for (d = 0; d < this._labels.length && !this._labels[d].stripLine; d++) this._labels[d].position < this.viewportMinimum || this._labels[d].position > this.viewportMaximum || (a.beginPath(), b = this.getPixelCoordinatesOnAxis(this._labels[d].position),
                    b = 1 === a.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, a.moveTo(b, c.y1 << 0), a.lineTo(b, c.y2 << 0), a.stroke());
    ...
    C.prototype.convertPixelToValue = function(a) {
        if (!a) return null;
        var b = 0;
        return b = this.conversionParameters.minimum + (("left" === this._position || "right" ===
    ...
    C.prototype.getXValueAt = function(a) {
        if (!a) return null;
        var b = null;
        "left" === this._position ? b = (this.chart.axisX.viewportMaximum - this.chart.axisX.viewportMinimum) / this.chart.axisX.lineCoordinates.height * (this.chart.axisX.lineCoordinates.y2 -
            a.y) + this.chart.axisX.viewportMinimum : "bottom" === this._position && (b = (this.chart.axisX.viewportMaximum - this.chart.axisX.viewportMinimum) / this.chart.axisX.lineCoordinates.width * (a.x - this.chart.axisX.lineCoordinates.x1) + this.chart.axisX.viewportMinimum);
        return b
    };
    C.prototype.calculateValueToPixelConversionParameters = function(a) {
        ...
        if ("bottom" ===
            this._position || "top" === this._position) a.pixelPerUnit = (this.reversed ? -1 : 1) * b / Math.abs(this.viewportMaximum - this.viewportMinimum), a.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1;
    ...
    C.prototype.calculateAxisParameters = function() {
        ...
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum =
            this.maximum;
        "axisX" === this.type ? (c = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, d = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 0 === d - c && (f = "undefined" === typeof this._options.interval ? 0.4 : this._options.interval, d += f, c -= f), Infinity !== this.dataInfo.minDiff ? e = this.dataInfo.minDiff : 1 < d - c ? e = 0.5 * Math.abs(d - c) : (e = 1, "dateTime" === this.chart.plotInfo.axisXValueType && (b = !0))) : "axisY" === this.type && (c = null !== this.viewportMinimum ? this.viewportMinimum :
            ...
            this.dataInfo.minDiff : 1 < d - c ? 0.5 * Math.abs(d - c) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < c && (c = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > d && (d = 0));
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
            this.intervalType || (f / 1 <= a ? (this.interval =
                ...
                (this.interval = 3, this.intervalType = "month") : f / (6 * D.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = f / (1 * D.yearDuration) <= a ? 1 : f / (2 * D.yearDuration) <= a ? 2 : f / (4 * D.yearDuration) <= a ? 4 : Math.floor(C.getNiceNumber(f / (a - 1), !0) / D.yearDuration), this.intervalType = "year"));
            ...
            this.valueFormatString || (b ? this.valueFormatString =
            ...
            0 === this.viewportMaximum && 0 === this.viewportMinimum &&
        ...
        if (null === this.minimum || null === this.maximum)
            if ("axisX" === this.type ? (c = null !== this.minimum ? this.minimum : this.dataInfo.min, d = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === d - c && (f = "undefined" === typeof this._options.interval ? 0.4 :
                ...
                -Infinity : this.sessionVariables.viewportMaximum)), 0 === this.maximum && 0 === this.minimum && (0 === this._options.minimum ? this.maximum += 10 : 0 === this._options.maximum && (this.minimum -= 10));
    ...
    ka.prototype.render = function() {
        ...
        if (0 < b) {
            ...
            if ("bottom" === this.parent._position ||
                "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, k = this.chart.plotArea.y2;
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (g = this.chart.getDataPointAtXY(a,
                    ...
                    if (g = va(a, b, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
                        ...
                        if (g.dataSeries.axisY)
                            if (0 < g.dataPoint.y.length) {
                                ...
                                f < g.dataPoint.y.length && f > -g.dataPoint.y.length &&
                                    e.push(g)
                            } else g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum && e.push(g);
                    else e.push(g)
                }
            }
            if (0 < e.length && (this.highlightObjects(e), this.enabled))
                if (f = "", f = this.getToolTipInnerHTML({
                    ...
                    "pie" === e[0].dataSeries.type || "doughnut" === e[0].dataSeries.type || "funnel" === e[0].dataSeries.type || "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? toolTipLeft = a - 10 - this.container.clientWidth : (toolTipLeft = e[0].dataSeries.axisX.conversionParameters.reference + e[0].dataSeries.axisX.conversionParameters.pixelPerUnit * (e[0].dataPoint.x - e[0].dataSeries.axisX.conversionParameters.minimum) - this.container.clientWidth <<
                        0, toolTipLeft -= 10);
                    ...
                    toolTipLeft += "px";
                    e = 1 !== e.length || this.shared || "line" !== e[0].dataSeries.type && "stepLine" !== e[0].dataSeries.type && "spline" !== e[0].dataSeries.type && "area" !== e[0].dataSeries.type && "stepArea" !== e[0].dataSeries.type && "splineArea" !== e[0].dataSeries.type && "stackedArea" !==
                        e[0].dataSeries.type && "stackedArea100" !== e[0].dataSeries.type ? "bar" === e[0].dataSeries.type || "rangeBar" === e[0].dataSeries.type || "stackedBar" === e[0].dataSeries.type || "stackedBar100" === e[0].dataSeries.type ? e[0].dataSeries.axisX.conversionParameters.reference + e[0].dataSeries.axisX.conversionParameters.pixelPerUnit * (e[0].dataPoint.x - e[0].dataSeries.axisX.viewportMinimum) + 0.5 << 0 : b : e[0].dataSeries.axisY.conversionParameters.reference + e[0].dataSeries.axisY.conversionParameters.pixelPerUnit * (e[0].dataPoint.y -
                            e[0].dataSeries.axisY.viewportMinimum) + 0.5 << 0;
                    e = -e + 10;
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                var d = this.chart.data[e.dataSeriesIndex],
                    ...
                    g = e.dataPointIndex;
                !1 === f.highlightEnabled || !0 !== d.highlightEnabled && !0 !== f.highlightEnabled || ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "scatter" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" ===
    ...
    Q.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
            ...
            for (var p = "", k = 0; k < a.length; k++)
                if (c = a[k].dataSeries, d = a[k].dataPoint, e = a[k].index, f = "", 0 === k && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] :
                        "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p, d, c, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== c._options.toolTipContent)) {
                    if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type) f += d.toolTipContent ?
                        d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}";
                    ...
                    else if ("pie" === c.type || "doughnut" === c.type || "funnel" === c.type) f += d.toolTipContent ?
                        d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "&nbsp;&nbsp;{y}";
                    else if ("rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type) f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
                    else if ("candlestick" === c.type || "ohlc" === c.type) f += d.toolTipContent ?
                        d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
                    null === b && (b = "");
            ...
            if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type) f = d.toolTipContent ?
                d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y}";
            else if ("bubble" === c.type) f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
            else if ("pie" === c.type || "doughnut" ===
                c.type || "funnel" === c.type) f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : (d.name ? "{name}:&nbsp;&nbsp;" : d.label ? "{label}:&nbsp;&nbsp;" : "") + "{y}";
            else if ("rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type) f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ?
                "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            ...
            null === b && (b = "");
            b += this.chart.replaceKeywordsWithValue(f,
                d, c, e)
        }
        return b
    };
    ...
    u.prototype.getPercentAndTotal = function(a, b) {
        var c = null,
            d = null,
            e = null;
        if (0 <= a.type.indexOf("stacked")) d = 0, c = b.x.getTime ? b.x.getTime() : b.x, c in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[c],
    ...
    u.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            h = h[a];
            null !== g && (h = h[g]);
            return "x" === a ? f.axisX && "dateTime" === f.plotInfo.axisXValueType ? qa(h,
    ...
    $.prototype.mouseEventHandler = function(a) {
        if ("mousemove" === a.type || "click" === a.type) {
            var b = [],
                c = ma(a),
                d = null;
            if ((d = this.chart.getObjectAtXY(c.x,
                    c.y, !1)) && "undefined" !== typeof this.objectMap[d])
    ...
    var A = {
            ...
            xScaleAnimation: function(a, b) {
                if (0 !== a) {
                    var c = b.dest,
                        d = b.source.canvas,
                        e = b.animationBase;
                    c.drawImage(d, 0, 0, d.width, d.height, e - e * a, 0, a * c.canvas.width / J, c.canvas.height /
                        J)
                }
            },
        ...
        K = {
            drawMarker: function(a, b, c, d, e, f, g, k) {
                if (c) {
                    ...
                    c.lineWidth = k ? k : 0;
                    "circle" === d ? (c.moveTo(a, b), c.beginPath(), c.arc(a, b, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), k && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p))) : "square" === d ? (c.beginPath(), c.rect(a - e / 2, b - e / 2, e, e), f && c.fill(),
        ...
        za = {
            ...
            formatNumber: function(a, b, c) {
                c = c || "en";
                if (ca[c]) return W(a, b || "#,##0.##", new ba(c));
                throw "Unknown Culture Name";
            },
            formatDate: function(a, b, c) {
                c = c || "en";
                if (ca[c]) return qa(a, b || "DD MMM YYYY", new ba(c));
                throw "Unknown Culture Name";
            }
        };
    za.Chart.version = "v1.8.0 Beta 3";
    window.CanvasJS = za
})();
/*
