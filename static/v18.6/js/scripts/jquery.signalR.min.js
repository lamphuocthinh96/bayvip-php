...
function(n, t) {
    ...
    r.transports.webSockets = {
        ...
        start: function(e, o, s) {
            ...
            e.socket || (h = e.webSocketServerUrl ? e.webSocketServerUrl : e.wsProtocol + "localhost:8010", h += i.getUrl(e, this.name, a), e.log("Connecting to websocket endpoint '" + h + "'."), e.socket = new t.WebSocket(h), e.socket.onopen = function() {
                c = !0;
